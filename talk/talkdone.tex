...
\>[B]{}\mathbf{data}\;\Conid{R}\;\Varid{ev}\;\Varid{a}\approx\Conid{Await}\;(\Varid{ev}\to \Conid{R}\;\Varid{ev}\;\Varid{a})\mid \Conid{Done}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
...
\>[13]{}\mathrel{=}{}\<[13E]%
\>[16]{}\Conid{MDown}\;\{\mskip1.5mu \Varid{but}\mathbin{::}\Conid{Int}\mskip1.5mu\}\mid {}\<[39]%
\>[39]{}\dots{}\<[39E]%
\\
\>[B]{}\Varid{mouseDown}\mathbin{::}\Conid{R}\;\Conid{GUIEv}\;\Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{mouseDown}\mathrel{=}\Conid{Await}\;(\lambda \Varid{x}\to \mathbf{case}\;\Varid{x}\;\mathbf{of}\;{}\<[38]%
\>[38]{}\Conid{MDown}\;\Varid{i}{}\<[47]%
\>[47]{}\to \Conid{Done}\;\Varid{i}{}\<[E]%
\\
\>[38]{}\anonymous {}\<[41]%
\>[41]{}\to \Varid{mouseDown}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sameClick}\mathbin{::}\Conid{R}\;\Conid{GUIEv}\;\Conid{Bool}{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{race}\mathbin{::}\Conid{R}\;\Varid{ev}\;\Varid{a}\to \Conid{R}\;\Varid{ev}\;\Varid{b}\to \Conid{R}\;\Varid{ev}\;(\Conid{R}\;\Varid{ev}\;\Varid{a},\Conid{R}\;\Varid{ev}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{before}\;\Varid{a}\;\Varid{b}\mathrel{=}\Varid{fmap}\;\Varid{cmp}\;(\Varid{race}\;\Varid{a}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;{}\<[10]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{doubler}\mathbin{::}\Conid{R}\;\Conid{GUIEv}\;(){}\<[E]%
\\
\>[B]{}\Varid{doubler}\mathrel{=}\mathbf{do}\;{}\<[15]%
\>[15]{}\Varid{rightClick}{}\<[E]%
\\
\>[15]{}\Varid{r}\leftarrow \Varid{rightClick}\mathbin{`\Varid{before}`}\Varid{sleep}\;\mathrm{0.2}{}\<[E]%
\\
...
\>[B]{}\Varid{define}{}\<[15]%
\>[15]{}\mathbin{::}{}\<[27]%
\>[27]{}\Conid{S}\;\Conid{GUIEv}\;\Conid{Box}\;\Conid{Rect}{}\<[E]%
\\
\>[B]{}\Varid{chooseColor}{}\<[15]%
\>[15]{}\mathbin{::}\Conid{Rect}\to {}\<[27]%
\>[27]{}\Conid{S}\;\Conid{GUIEv}\;\Conid{Box}\;\Conid{Color}{}\<[E]%
\\
\>[B]{}\Varid{clickOn}{}\<[15]%
\>[15]{}\mathbin{::}\Conid{Rect}\to {}\<[27]%
\>[27]{}\Conid{R}\;\Conid{GUIEv}\;(){}\<[E]%
\\
...
\\
\>[B]{}\Varid{cycleColor}\mathrel{=}\Varid{cc}\;\Varid{colors}\;\mathrm{0}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{rList}\mathbin{::}\Conid{S}\;\Varid{ev}\;\Varid{f}\;()\to \Conid{S}\;\Varid{ev}\;[\mskip1.5mu \Varid{f}\mskip1.5mu]\;(){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{minipage}
\end{tabular}
...
\>[14]{}\approx{}\<[14E]%
\>[18]{}\Conid{Await}\;(\Varid{ev}\to \Conid{R}\;\Varid{ev}\;\Varid{a}){}\<[E]%
\\
\>[14]{}\mid {}\<[14E]%
...
\>[B]{}\mathbf{data}\;\Conid{R}\;\Varid{ev}\;\Varid{a}{}\<[14]%
\>[14]{}\approx{}\<[14E]%
\>[18]{}\Conid{Await}\;(\Conid{Requests}\;\Varid{ev})\;(\Varid{ev}\to \Conid{R}\;\Varid{ev}\;\Varid{a}){}\<[E]%
\\
\>[14]{}\mid {}\<[14E]%
\>[18]{}\Conid{Done}\;\Varid{a}{}\<[E]%
\ColumnHook
...
\item \ensuremath{\Varid{race}\;\Varid{a}\;\Varid{b}} requests the union of the requests of \ensuremath{\Varid{a}} and \ensuremath{\Varid{b}} 
\end{itemize}
All other (Signal computation) combinators are expressed in terms of \ensuremath{\bind } and \ensuremath{\Varid{race}}
...
\node[bag, name=root] {\ensuremath{\Varid{race}}}
  [sibling distance=4.5cm]
  child {node[bag] {\ensuremath{\Varid{race}}}[sibling distance=2cm]
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{race}\;(\Varid{race}\;\Varid{mouseMove}\;\Varid{mouseUp})\;(\Varid{mouseDown}\sequ \Varid{deltaTime}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{frame}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{race}\;(\Varid{race}\;\Varid{mouseMove}\;\Varid{mouseUp})\;\Varid{deltaTime}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{frame}
